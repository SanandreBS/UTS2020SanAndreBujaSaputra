package ac.id.atmaluhur.uts_amub_1711500084_sanandrebujasaputra;
...
public class RegisterTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getUsernameLocal();
        pic_photo_register_user = findViewById(R.id.picture_photo_register_user);
        img_btn_add_photo = findViewById(R.id.image_btn_add_photo);
        img_btn_register2 = findViewById(R.id.image_button_regis_dua);
        ed_hobi = findViewById(R.id.edit_hobinya);
        ed_alamat = findViewById(R.id.edit_alamatnya);
